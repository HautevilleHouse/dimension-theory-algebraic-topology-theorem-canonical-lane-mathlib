import DimensionTheoryAlgebraicTopologyTheoremCanonicalLaneLean.FinalTheorem
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "dimension-theory-algebraic-topology",
  theoremObject := "Dimension Theory Algebraic Topology Theorem",
